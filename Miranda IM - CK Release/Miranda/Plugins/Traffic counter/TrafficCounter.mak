...
!IF "$(CFG)" != "tcounter - Win32 Release" && "$(CFG)" != "tcounter - Win32 Debug" && "$(CFG)" != "tcounter - Win32 Release Unicode" && "$(CFG)" != "tcounter - Win32 Debug Unicode"
...
CPP_PROJ=/nologo /MD /W3 /Zi /O2 /I "../../Include" /D "WIN32" /D "NDEBUG" /D "_WINDOWS" /D "_MBCS" /D "_USRDLL" /D "TCOUNTER_EXPORTS" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
...
LINK32=link.exe
LINK32_FLAGS=msimg32.lib comctl32.lib kernel32.lib user32.lib gdi32.lib oleaut32.lib Shlwapi.lib /nologo /dll /incremental:no /pdb:"$(OUTDIR)\TrafficCounter.pdb" /debug /machine:I386 /out:"$(OUTDIR)\TrafficCounter.dll" /implib:"$(OUTDIR)\TrafficCounter.lib" /pdbtype:sept 
LINK32_OBJS= \
...
CPP_PROJ=/nologo /MD /W3 /ZI /Od /I "../../Include" /D "WIN32" /D "_DEBUG" /D "_WINDOWS" /D "_USRDLL" /D "TCOUNTER_EXPORTS" /D "_UNICODE" /D "UNICODE" /Fo"$(INTDIR)\\" /Fd"$(INTDIR)\\" /FD /c 
MTL_PROJ=/nologo /D "NDEBUG" /mktyplib203 /win32 
RSC_PROJ=/l 0x409 /fo"$(INTDIR)\resource.res" /d "NDEBUG" 
BSC32=bscmake.exe
BSC32_FLAGS=/nologo /o"$(OUTDIR)\TrafficCounter.bsc" 
