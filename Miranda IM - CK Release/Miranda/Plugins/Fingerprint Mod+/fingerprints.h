...
//#########################################################################################################################################
	...
	{ "client_QIP_Infium",				_T("|QIP Infium*|http://qip* 9???")
										_T("|http://qip* 6???"),						_T("QIP Infium"),						_T("ClientIcons_Multiprotocols"),	IDI_QIP_INFIUM, INVALID_HANDLE_VALUE, MULTIPROTOCOL_CASE },
...
//#########################################################################################################################################
	...
	{ "client_yaonline",				_T("|*yandex*|*Я.Онлайн*|*Яндекс*|*yaonline*"),	_T("YA online"),						_T("ClientIcons_Jabber"),	IDI_YAONLINE, INVALID_HANDLE_VALUE, JABBER_CASE },
...
//#########################################################################################################################################
	...
	{ "client_KDL_",			_T("|*KDL*|*КДЛ*"),							_T("KDL"),								_T("ClientIcons_Packs"),	IDI_MIRANDA_KDL, INVALID_HANDLE_VALUE, PACKS_CASE },
...
{//	IconName							Mask										Icon caption							NULL ICON_RESOURCE_ID
	...
	{ "client_home_overlay",			_T("|*[*home*]*|*[*дом*]*"),				_T("[Home]"),							_T("ClientIcons_Jabber"),	IDI_HOME_OVERLAY, INVALID_HANDLE_VALUE, OVER2_CASE },
	{ "client_work_overlay",			_T("|*[*work*]*|*[*работа*]*"),				_T("[Work]"),							_T("ClientIcons_Jabber"),	IDI_WORK_OVERLAY, INVALID_HANDLE_VALUE, OVER2_CASE },
	{ "client_office_overlay",			_T("|*[*office*]*|*[*офис*]*"),				_T("[Office]"),							_T("ClientIcons_Jabber"),	IDI_OFFICE_OVERLAY, INVALID_HANDLE_VALUE, OVER2_CASE },
