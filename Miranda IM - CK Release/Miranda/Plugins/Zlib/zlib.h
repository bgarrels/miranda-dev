...
#define ZLIB_VERSION "1.2.6"	/* Version number */
#define ZLIB_VERNUM 0x1260		/* Version number */
#define ZLIB_VER_MAJOR 1		/* Major number */
#define ZLIB_VER_MINOR 2		/* Minor number */
#define ZLIB_VER_REVISION 6		/* Revision number */
#define ZLIB_VER_SUBREVISION 0	/* Subversion number */
