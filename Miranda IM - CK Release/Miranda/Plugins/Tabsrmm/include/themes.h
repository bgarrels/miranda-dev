 ...
 * The class CSkin implements the skinning engine and loads skins from their skin
   definition files (.tsk).
 
 * CImageItem implements a single rectangular skin item with an image and its rendering.
 */
