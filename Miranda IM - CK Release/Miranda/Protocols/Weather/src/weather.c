...
* Main file for the Weather Protocol, includes loading, unloading, upgrading,
* support for plugin uninsaller, and anything that doesn't belong to any other file.
*/
