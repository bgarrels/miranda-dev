...
* This file contain the source related to weather protocol services as required
* for a Miranda protocol. Also, it contains functions for building/changing the
* weather menu items.
*/
