...
// Version management
#include "build.h"
#define __VERSION_DWORD             PLUGIN_MAKE_VERSION(0, 0, 6, 7)
#define __PRODUCT_DWORD             PLUGIN_MAKE_VERSION(0, 9, 14, 0)
#define __VERSION_STRING            "0.0.6.7"
#define __PRODUCT_STRING            "0.9.14.0"
#define __VERSION_VS_FILE           0,0,6,7
#define __VERSION_VS_PROD           0,9,14,0
#define __VERSION_VS_FILE_STRING    "0, 0, 6, 7"
