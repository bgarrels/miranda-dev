...
* This file contain the source related to loading the reading the weather ini files
* and store them into memory. Also containing code for unloading and getting weather
* data from the ini settings.
*/
