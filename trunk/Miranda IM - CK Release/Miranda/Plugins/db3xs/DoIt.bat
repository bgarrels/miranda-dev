"%ProgramFiles%\Microsoft Visual Studio 10.0\Common7\IDE\devenv.exe" /REBUILD "Release Unicode" db3xS.sln
"%ProgramFiles%\Microsoft Visual Studio 10.0\Common7\IDE\devenv.exe" /REBUILD "Release" db3xS.sln
"%ProgramFiles%\Microsoft Visual Studio 10.0\Common7\IDE\devenv.exe" /REBUILD "Release Unicode" ..\db3x_mmap_secure_mod\db_autobackups\db_autobackups.sln
"%ProgramFiles%\Microsoft Visual Studio 10.0\Common7\IDE\devenv.exe" /REBUILD "Release" ..\db3x_mmap_secure_mod\db_autobackups\db_autobackups.sln
