...
* Functions used by Miranda to launch the plugin. Centralizes functions needed
* by Miranda IM to get information about the plugin and to initialize it and to
