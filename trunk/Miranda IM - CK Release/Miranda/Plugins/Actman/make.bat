...
..\Delphi\Awkward\brcc32.exe %myopts% options.rc     -fooptions.res
..\Delphi\Awkward\brcc32.exe %myopts% hooks\hooks.rc -fohooks\hooks.res
..\Delphi\Awkward\brcc32.exe %myopts% tasks\tasks.rc -fotasks\tasks.res
..\Delphi\Awkward\brcc32.exe %myopts% ua\ua.rc       -foua\ua.res
